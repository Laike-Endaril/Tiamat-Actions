...
public class GUINodeView extends GUIPanZoomView
{
    ...
    static
    {
        ...
        addOption("Entity Getters", "Get Entity X", CNodeGetEntityX.class);
        addOption("Entity Getters", "Get Entity Y", CNodeGetEntityY.class);
        addOption("Entity Getters", "Get Entity Z", CNodeGetEntityZ.class);
        ...
        addOption("Math", "Get Vector Y", CNodeGetVectorY.class);
        addOption("Math", "Get Vector Z", CNodeGetVectorZ.class);
        ...
        addOption("Arrays", "Set Array Value", CNodeSetArrayValue.class);
        ...
        addOption("Lists", "Set List Value", CNodeSetListValue.class);
