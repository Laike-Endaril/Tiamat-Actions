...
public class CNodeIsItemstackActive extends CNode
{
     ...
     */
    public CNodeIsItemstackActive()
    {
        super();
    }

    public CNodeIsItemstackActive(String actionName, String event, int x, int y)
    {
