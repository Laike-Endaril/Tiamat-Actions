...
public class CNodeEntityFilterInSphere extends CNode
{
    protected static final ResourceLocation TEXTURE = new ResourceLocation(MODID, "image/node/entities_in_sphere.png");
     ...
     */
    public CNodeEntityFilterInSphere()
    {
        super();
    }

    public CNodeEntityFilterInSphere(String actionName, String event, int x, int y)
    {
    ...
    {
        return "Only keep entities that collide with a given sphere";
    }
    ...
    public Object execute(CAction mainAction, CAction subAction, Object... inputs)
    {
        ...
        return EntityFilters.inSphere((Vec3d) inputs[0], Double.parseDouble("" + inputs[1]), inclusionMode, entities).toArray(new Entity[0]);
    }
    ...
    {
        return new EntityFilterInSphereNodeGUI(this);
    }


    @Override
    public CNodeEntityFilterInSphere write(ByteBuf buf)
    {
        super.write(buf);
    ...
    @Override
    public CNodeEntityFilterInSphere read(ByteBuf buf)
    {
        super.read(buf);
    ...
    @Override
    public CNodeEntityFilterInSphere save(OutputStream stream)
    {
        super.save(stream);
    ...
    @Override
    public CNodeEntityFilterInSphere load(InputStream stream)
    {
        super.load(stream);
    ...
    @SideOnly(Side.CLIENT)
    public static class EntityFilterInSphereNodeGUI extends GUIScreen
    {
        protected EntityFilterInSphereNodeGUI(CNodeEntityFilterInSphere node)
        {
            show(node);
        }
        ...
        public String title()
        {
            return "Entity Filter: 'In Sphere' Node";
        }

        protected void show(CNodeEntityFilterInSphere node)
        {
            show();
